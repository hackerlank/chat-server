...
import com.randioo.chat_server.protocol.Login.LoginCheckAccountResponse;
import com.randioo.chat_server.protocol.Login.LoginCreateRoleResponse;
import com.randioo.chat_server.protocol.Login.LoginGetRoleDataResponse;
...
public class LoginServiceImpl extends ObserveBaseService implements LoginService {
	...
	public RoleData getRoleData(Role role) {
		...
		return RoleData.newBuilder().build();
	}
